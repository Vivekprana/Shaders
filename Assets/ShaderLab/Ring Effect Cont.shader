Shader "Unlit/Ring effect Cont"
{
    ...
    SubShader
    {
        ...
        ZWrite Off // Makes an object transparent by allowing items in the back to be written to depth buffer.
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                return t * (abs(i.normal.y) < 0.999); // abs > .9999 removes top part of mesh and bottom part;
            }
            ENDCG
        }
    }
